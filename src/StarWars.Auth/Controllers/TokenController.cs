...
using StarWars.Auth.Models;

namespace StarWars.Auth.Controllers
{
    ...
    public class TokenController : ControllerBase
    {
        ...
        public IActionResult Get([FromBody] TokenRequest tokenRequest)
        {
            ...
            { 
                ...
                var secret = _configuration["StarWars:Auth:Secret"];
                var issuer = _configuration["StarWars:Auth:Issuer"];
                var audience = _configuration["StarWars:Auth:Audience"];
